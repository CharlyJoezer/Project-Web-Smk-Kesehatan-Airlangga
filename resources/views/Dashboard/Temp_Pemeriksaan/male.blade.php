@if($kategori['hematologi'] != null)
    <tr style="border-top: 1px solid #555!important;">
    ...
    <tr>
        ...
        <td class="text-center">4,5 - 5,5 jt/Ul</td>
...
@if($kategori['glukosa_darah'] != null)
    <tr>
...
@if($kategori['ginjal'] != null)
    ...
    <tr>
        ...
        <td class="text-center">3,4 - 7 mg/dL</td>
    </tr>
@endif
...
@if($kategori['hati'] != null)    
    ...
    <tr>
        ...
        <td class="text-center">8 - 61 U/L</td>
    </tr>
    <tr>
